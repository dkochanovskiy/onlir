...
class CreateOffersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('offers', function (Blueprint $table) {
            ...
            $table->unsignedTinyInteger('warehouse number')->nullable();
            $table->string('nearest _metro _station', 100)->nullable();
            ...
            $table->unsignedTinyInteger('possible with children')->nullable();
            $table->unsignedTinyInteger('pets allowed')->nullable();
