            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    ...
                    <form method="post" action="{{route('ad-placement-apartment')}}" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        {{--<div class="form-group">--}}
                            {{--<label for="name_settlement" class="col-md-3 control-label">Название населенного пункта</label>--}}
                            {{--<div class="col-md-6">--}}
                                {{--<input type="text" name="name_settlement" class="form-control" id="name_settlement" value="{{old('name_settlement')}}">--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        {{--<div class="form-group">--}}
                            {{--<label for="street" class="col-md-3 control-label">Название улицы</label>--}}
                            {{--<div class="col-md-6">--}}
                        ...
                        <hr>
                        <div class="form-group">
                            <label for="img_1" class="col-md-2 control-label">Изображение</label>
                            <div class="col-md-8">
                                <input type="file" name="img_1" class="filestyle" id="img_1">
                            </div>
                            {{--{!! Form::label('img_1','Изображение',['class' => 'col-md-2 control-label']) !!}--}}
                            {{--<div class="col-md-8">--}}
                                {{--{!! Form::file('img_1',['class'=>'filestyle','data-buttonText'=>'Выберите изображение','data-buttonName'=>'btn-primary','data-placeholder'=>'Файл отсутствует']) !!}--}}
                            {{--</div>--}}
                        </div>
                        {{--<hr class="col-md-12">--}}
                        {{--<div class="row">--}}
